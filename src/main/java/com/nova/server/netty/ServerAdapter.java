package com.nova.server.netty;

import org.slf4j.LoggerFactory;

import com.nova.game.model.ChannelManager;
import com.nova.server.dispatcher.HandlerDispatcher;
import com.nova.server.domain.ERequestType;
...
public class ServerAdapter extends SimpleChannelInboundHandler<Object> {
	...
	public void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
		LoggerFactory.getLogger(ServerAdapter.class).error("handlerRemoved " + ctx.hashCode());
		// zhangxx test begin
	...
	public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
		LoggerFactory.getLogger(ServerAdapter.class).error("handlerAdded " + ctx.hashCode());
		super.handlerAdded(ctx);
	}
	
	@Override
	public void channelInactive(ChannelHandlerContext ctx) throws Exception {
		// LoggerFactory.getLogger(ServerAdapter.class).error("channelInactive " + ctx.hashCode());
...
//	}
	...
	private void socketRequest(ChannelHandlerContext ctx, Object msg) throws Exception {
		LoggerFactory.getLogger(ServerAdapter.class).error("socketRequest ");
